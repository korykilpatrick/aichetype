      ...
      <Container style={{ marginTop: '20px', marginBottom: '20px' }}>
        <Row>
          <Col>
            ...
            <p>
              I feel fortunate to have experienced success in my professional life thus far and I'm proud of what I've accomplished, but my heart and mind yearn for new horizons.
            </p>
          </Col>
        </Row>
      </Container>
