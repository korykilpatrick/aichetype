      ...
      <Container style={{ marginTop: '20px', marginBottom: '20px' }}>
        <Row>
          <Col>
            ...
            <p>Since then, I've dabbled in various endeavors while figuring out which deepend to jump into next. Most notably, <Link to="/sportsanalytics">I've partnered with professional sports bettors</Link> to do data analytics, develop novel betting algorithms, and streamline their workflow. I've also done some angel investing, continued my CS <Hoverable text="Mostly via ChatGPT rabbitholes and Bradfield's new online platform <a href='https://csprimer.com' target='_blank'>CS Primer</a>.">education,</Hoverable> and been an active mentor on <a href="https://www.backrs.com/" target="_blank">Backrs</a>. I spent the first half of the year meeting with early stage founders, but I didn't find any sufficiently compelling <Hoverable text="I got close to joining a promising medtech startup as CTO, but they aren't Austin-based and I decided working in-person is non-negotiable for me right now.">opportunities.</Hoverable>
            </p>
            <p>
              I've reached a pretty cushy place professionally, which means it's time for a change. I quit poker because it wasn't fulfilling. I got into tech because I believe software is the great lever of our time. I built a company to uplevel my programming skills. Now I want to channel my skills, and learn new ones, toward a mission I'm passionate about.
            </p>
          </Col>
        </Row>
      </Container>
