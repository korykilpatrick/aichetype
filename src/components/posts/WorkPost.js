    ...
    return (
      <Container style={{ marginTop: '20px', marginBottom: '20px' }}>
        <Row>
          <Col>
            <p>
              I've never had a traditional job. I <a href="/poker">became quite good</a> at online poker in high school, which had the fortunate benefit of making me money. By the time I graduated high school I had earned over <Hoverable text="From an initial, and at the time lofty, $20 deposit">$100,000.</Hoverable> I went to college, where I made more than $1 million as a teenager, mostly in my dorm room between classes and basketball practice.
            </p>
            <p>
