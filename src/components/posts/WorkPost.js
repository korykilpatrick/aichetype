      ...
      <Container style={{ marginTop: '20px', marginBottom: '20px' }}>
        <Row>
          <Col>
            ...
            <Image url="https://www.wsop.com/images/imagestore/flashlarge/Champion_Kory_Kilpatrick.JPG" caption="" />
            <p>
              By 2015 I was ready to move on. I still enjoyed playing and was winning at peak rates, but I was increasingly not okay with the fact that I was spending all my time and energy mastering a zero-sum game. I spent some time traveling to poker stops around the world and volunteering in the area. During this time, I found myself increasingly drawn to technology, and in particular to its enormous potential as a force for good. 
            </p>
            <Image url="https://korykilpatrick-bucket.s3.us-west-1.amazonaws.com/volunteering.jpeg" caption="LEFT: I spent a couple months with some sweet kids at an orphanage in Cusco, Peru. Being with them strengthened my yearning to pivot into mission-oriented work. RIGHT: I spent 6 weeks at Elephant Nature Park in Chiang Mai, Thailand. Some quick back of the envelope math indicates I shoveled 15-20 tons of shit during my time there." zoom={true} />
            <p>
              ...
              <Image url="https://korykilpatrick-bucket.s3.us-west-1.amazonaws.com/cs_nerds.jpg" caption="I got hooked on Catan during this period and became top 5 in the world on <a href='https://catanuniverse.com/en' target='_blank'>Catan Universe</a> 😬" />
