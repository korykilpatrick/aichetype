    ...
    return (
      <Container style={{ marginTop: '20px', marginBottom: '20px' }}>
        <Row>
          <Col>
            <p>
              I've never had a traditional job. I became quite good at online poker in high school, which had the fortunate benefit of making me money. By the time I graduated high school I had earned over <Hoverable text="From an initial, and at the time lofty, $20 deposit">$100,000</Hoverable>. I went to college, where I made more than $1 million as a teenager, mostly in my dorm room between classes and basketball practice.
            </p>
            <p>
              After graduating in <Hoverable text="with a degree in..uh..Political Economy?">2012</Hoverable>, I went <Hoverable text="😉">all-in</Hoverable> on poker, dedicating virtually every waking moment to playing or studying. 
            ...
            <Image url="https://www.wsop.com/images/imagestore/flashlarge/Champion_Kory_Kilpatrick.JPG" caption="There is an extraordinary amount of variance in tournament poker, so winning a WSOP bracelet is a feat far less impressive than being a significant winner over a large sample size in some of the biggest and most competitive cash games on the internet. But alas, shiny things are shiny so I guess this is how I should headline my poker resumé!" />
            <p>
            ...
            <p>A year later, we had the top product in our niche. Another year and the software was almost entirely <Hoverable text="It still irks me that we couldn't *fully* automate the software, but it often has to respond to unpredictably structured data while also being completely fault-intolerant so some human oversight is required. *sigh*. We did build some great tooling that makes maintenance as simple as possible though.">self-sustaining,</Hoverable> at which point I felt it was time to move on. I left the company, but Jordan and Matt are still doing well running it today<Hoverable text="I feel incredibly fortunate to have had this experience with two of my best friends in the world. I will certainly be pulling out all the stops to try to recruit them to join me in whatever I do next."></Hoverable>.
            </p>
            <p>Since then, I've dabbled in various endeavors while figuring out my next big move. Most notably, I've <Link to="/dfs">partnered</Link> with professional sports bettors to do data analytics, develop novel betting algorithms, and streamline their workflow. I've also done some angel investing, continued my CS <Hoverable text="Mostly via ChatGPT rabbitholes and Bradfield's new online platform [CS Primer](https://csprimer.com).">education</Hoverable>, and been an active mentor on <a href="https://www.backrs.com/" target="_blank">Backrs</a>.
            </p>
            <p>
              I'm now seeking a completely new quest. I'm very fortunate to have had success in my work so far, so I'm being picky. But I'm getting antsy! I yearn to be on the frontier of the most interesting and important technological work in the world. I'm particularly interested in studying AI and the brain, but I'm open to helping bring to life anything that I feel needs to exist in the world.
            </p>
          </Col>
        </Row>
      </Container>
