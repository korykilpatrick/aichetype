    ...
    return (
        <div className="container">
            <Card.Body>
                ...
                <p>
                    One note worth mentioning - my success in poker did not come from a supernatural intuition, but from being a math nerd.<Hoverable text="I was a competitive athlete and mathlete growing up!"></Hoverable>  I was on the frontier of transforming poker from a psychology competition to a math competition. The top poker players regularly use AI tools <Hoverable text="Such as <a href='https://piosolver.com/' target='_blank'>Pio Solver</a> and <a href='https://www.runitonce.com/vision-gto-trainer/'>Vision</a>"></Hoverable> to study the game with extreme mathematical rigor. As a pro half my time was spent playing<Hoverable text="and saving the hands into a database to be studied later"></Hoverable> and the other half was spent working with poker tools, Excel, and a large database of poker data.
                </p>
