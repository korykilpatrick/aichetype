    ...
    return (
        <div className="container">
            <Card.Body>
                ...
                <p>
                    I started playing poker in high school. It was a perfect confluence of my biggest interests at the time: math, competition, and people. I made over $1 million as a teenager, and by my mid-20s I had earned enough to retire.
                </p>
                <p>
                   My success did not come from a supernatural intuition, but from being a math nerd.<Hoverable text="I was a competitive athlete and mathlete growing up"></Hoverable> I was on the frontier of transforming poker from a psychology competition to a math competition. The top players regularly use AI tools <Hoverable text="such as <a href='https://piosolver.com/' target='_blank'>Pio Solver</a> and <a href='https://www.runitonce.com/vision-gto-trainer/'>Vision</a>"></Hoverable> to study the game with extreme mathematical rigor. As a pro half my time was spent playing<Hoverable text="with hands being saved into a database"></Hoverable> and the other half was spent with study tools, Excel, and a large database. 
                </p>
                <p>    
                    Poker taught me to think critically. The lack of guardrails and tight feedback loop make for an excellent, if not brutal, arena to develop problem-solving skills. Coding felt like a natural transition from my poker work - as if I'm applying the same problem-solving process to a different game with different rules and constraints.<Hoverable text="sounds like a good thing for me to write about at some point!"></Hoverable> 
                </p>
                <p>
