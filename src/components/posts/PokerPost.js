    ...
    return (
        <div className="container">
            <Card.Body>
                ...
                <p>
                    I'm assuming Neuralink doesn't care much about the particulars of my poker career other than it being a proof of concept of <em>some kind of</em> competency. In case I'm misguided about that, I recorded a video of myself playing a $2000 buy-in game while discussing my history with and approach to the game. Below you will also find a database and graph of my results from playing recreationally since 2017. Finally, I included some links to my results from publicly tracked games,<Hoverable text="most of the games I played in my career were not publicly tracked. This had the perk of my results not scaring away competition, but the drawback that I don't have enough data to speak definitively about e.g. where I fit into online poker history."></Hoverable> as well as an article written about me at the World Series of Poker this summer.
                </p>
