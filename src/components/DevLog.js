    ...
    return (
        <div>
            ...
            <section>
                ...
                <p>
                    I deliberated whether to have content hard-coded into React components or stored in a database. Hard-coding is simpler<Hoverable text="just copy a template for a post, write the content, and voila!"></Hoverable>  and has faster page loads.<Hoverable text="since theres no db calls to fetch data"></Hoverable> Database content is more flexibile,<Hoverable text="you can dynamically manage content, like filtering, sorting, searching, or tagging posts"></Hoverable> more scalable,<Hoverable text="a 1:1 ratio of components to posts becomes ridiculous at some point"></Hoverable>, more maintainable,<Hoverable text="if you want to change the layout of posts, you only have to change it in one place. updating post content is as simple as executing a db query, as opposed to having to pull down new code on the instance and recompile/bundle it"></Hoverable> and has a cleaner separation of concerns.<Hoverable text="the frontend is content agnostic - its only concerned about display"></Hoverable> 
                </p>
                <p>
